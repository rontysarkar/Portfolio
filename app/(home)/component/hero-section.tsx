...
const HeroSection = () => {
  return (
    <div
      id="home"
      className="min-h-[72vh] flex flex-col-reverse gap-12 lg:gap-0 lg:flex-row items-center justify-between animate-move-up"
    >
      <div className="space-y-10 text-center lg:text-left">
        ...
        <p className="md:px-10 lg:px-0 lg:pr-56 text-md text-gray-300">
          {
        ...
        <div className="flex flex-col mx-auto md:flex-row md:justify-center lg:justify-start  items-center gap-6">
          <Link href={"resume.pdf"} download className="inline-block group">
          ...
          >
            <div>
              <h1 className="text-2xl hover:text-green-400 transition-all font-bold flex items-center gap-2">
                Contact Me{" "}
                <SiWhatsapp className="text-2xl text-green-500" />{" "}
              </h1>
